...
public interface BookProcessor {
    CompletableFuture<BookInfo> processFileAsync(Uri bookUri) throws IOException;
    CompletableFuture<BookInfo> processFileAsync(File bookFile) throws IOException;
